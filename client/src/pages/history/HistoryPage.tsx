...
function ScoreDeltaRow({
  ...
  return (
    <div
      className={`flex items-center justify-between rounded-xl px-4 py-3 ${bg}`}
    >
...
function SkillChip({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium ${styles[type]}`}
    >
...
export function HistoryPage() {
  ...
  const compareSelected = (id: string) =>
    compareIds?.[0] === id ||
    compareIds?.[1] === id;
    ...
    <PageShell>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-[var(--text-secondary)] mt-1 text-sm">
            {entries.length} scan
            {entries.length !== 1 ? 's' : ''} — each
            saved as an independent snapshot
          </p>
        </div>
          ...
          {mode === 'view' && (
            <>
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold border border-[var(--border)] text-[var(--text-primary)] hover:bg-[var(--bg-subtle)] transition-all disabled:opacity-40 text-sm"
              >
          ...
          {mode === 'edit' && (
            <>
              <button
                ...
                className="px-5 py-2.5 rounded-xl font-bold border border-[var(--border)] text-[var(--text-primary)] hover:bg-[var(--bg-subtle)] transition-all text-sm"
              >
                {selectedIds.size ===
                entries.length
                  ? 'Deselect All'
              ...
              {selectedIds.size > 0 && (
                ...
                >
                  {isBusy ? (
                    <InlineSpinner className="border-[#ff6b6b]/30 border-t-error" />
                  ) : (
                    <span className="material-symbols-outlined text-sm">
                      delete
                    </span>
      ...
      <QueryBoundary
        ...
        emptyProps={{
          ...
          title: 'No scans yet',
          description:
            'Run your first career analysis from the Dashboard.',
          onAction: () =>
      ...
      <ConfirmDialog
        ...
        description={
          confirmType === 'all'
            ? 'This permanently deletes your entire analysis history. Cannot be undone.'
            : `Permanently delete ${selectedIds.size} selected analyses. Cannot be undone.`
        }
        confirmLabel="Delete"
        danger
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <div className="text-right">
            <p className="text-2xl font-extrabold text-[var(--accent)] leading-none">
              {entry.score}
            </p>
...
function RichComparisonPanel({
  ...
  return (
    <div
      className="mt-4 rounded-2xl p-4 text-center overflow-hidden"
      style={{
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            {[
              ...
              ({ snapshot, label }) => (
                ...
                >
                  <p className="text-xs font-bold text-[var(--text-secondary)] uppercase tracking-widest mb-1">
                    {label}
                  </p>

                  <p className="font-bold text-[var(--text-primary)] truncate mb-1">
                    {snapshot.roleTitle}
                  </p>
          ...
          {activeTab === 'overview' && (
            <div className="space-y-3">
              <p className="text-xs font-bold text-[var(--text-secondary)] uppercase tracking-widest mb-4">
                Score Breakdown
              </p>
            ...
            <div className="space-y-5">
              {comparison
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {comparison.newlyMatchedSkills.map(
                      (s) => (
                        <SkillChip
                          key={s}
                          skill={s}
              ...
              {comparison
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {comparison.stillMissingSkills.map(
                      (s) => (
                        <SkillChip
                          key={s}
                          skill={s}
            ...
            <div className="space-y-4">
                  ...
                  ({
                    ...
                    >
                      ...
                      <div className="flex items-center justify-center gap-3">
                        ...
                        <span className="material-symbols-outlined text-[var(--text-secondary)] text-sm">
                          arrow_forward
                        </span>
              ...
              {comparison.base.skillMatch
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {comparison.compare.skillMatch?.requiredSkills?.map(
                      (skill) => {
                        const matched =
                          comparison.compare
                            .skillMatch
